      ...
      <section className="pt-36 pb-20 bg-darkBlue">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            />
            <AnimatedText
              text={<h1 className="text-4xl md:text-5xl font-bold mb-6">Comprehensive Software Solutions</h1>}
              animation="slide-up"
              delay={100}
              className="mb-6"
            />
            <AnimatedText
              text={
                <p className="text-gray-300 text-lg">
                  From web and mobile development to UI/UX design and digital marketing, we offer end-to-end services to help businesses thrive in the digital landscape.
                </p>
              }
              animation="slide-up"
              delay={200}
